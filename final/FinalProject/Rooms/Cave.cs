class Cave : Room
{
    public Cave(int level) : base(
        ...
        , new List<Enemy>()
        , new StatCheck(
            "Upon further inspection you see a skeleton in armor, likely a less fortuanate adventurer. Would you like to take their armor?"
            , "Out of respect for the dead you leave the skeleton alone."
            , "You grab the gear and continue into the cave."
            , "health"
            , 0
            , new List<Item>(){new Coin(3), new Axe(), new Food("ration", 4, 1, 5)}
        )
    ){}
}